...
#define H8_3069_SCI0 ((volatile struct h8_3069f_sci *)0xffffb0)
#define H8_3069_SCI1 ((volatile struct h8_3069f_sci *)0xffffb8)
#define H8_3069_SCI2 ((volatile struct h8_3069f_sci *)0xffffc0)
...
/* Array of struct {volatile struct h8_3069f_sci *sci;} 
 * Initialize with H8_3069_SCI0~1
 */
/* Why can't it be a simple array of pointers like
 * volatile static struct h8_3069f_sci *regs[SERIAL_SCI_NUM] = 
...
unsigned char serial_recv_byte(int index)
{
    ...
    c = sci->rdr;
    sci->ssr &= ~H8_3069F_SCI_SSR_RDRF; // recv complete
